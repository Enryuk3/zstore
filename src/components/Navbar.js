...
function Navbar() {
  ...
  return (
    <div className=" lg:sticky flex flex-wrap items-center justify-between p-6 bg-z-dark-blue relative z-50">
      ...
      <div className="flex-1">
        <li className="ml-8 text-xl normal-case text-left text-white list-none" ><Link to='/'>Z Store</Link></li>
      </div>
      
      <div id="menu" className={`w-full left-0 bg-z-dark-blue z-10 absolute md:static flex-grow block md:flex md:items-center md:w-auto transition-all duration-500 ease-in ${open ? 'top-[96px] opacity-100':'top-[-490px] md:top-0 md:opacity-100 opacity-0'}`}>
